jQuery(document).ready(function ($) {
	...
	$('#slider-gallery #menu ul li a').click(function(e){
		...
		$('#slider-gallery #slides').stop().animate({marginLeft:-positions[pos]+'px'},450,'easeInOutQuad', function() {
		$('.profile-quote p').stop().fadeIn(400,'easeOutQuad')	
		});
		/* Start the sliding animation */
		/* add the function call here to fade in the text after slide animation */
