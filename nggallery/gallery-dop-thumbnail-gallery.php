...
<!--    
    var DOPNextGENThumbnailGallerySettings<?php echo $gallery->ID;?> = {
        "Width": 432, // Width (value in pixels). Default value: 900. Set the width of the gallery.
        "Height": 440, // Height (value in pixels). Default value: 600. Set the height of the gallery.
        ...
        "ThumbnailsPosition": "right", // Thumbnails Position (top, right, bottom, left). Default value: bottom. Set the position of the thumbnails in the gallery.
        ...
        "ThumbnailsBgColor": "ffffff", // Thumbnails Background Color (color hex code). Default value: f1f1f1. Set the color for the thumbnails background.
        "ThumbnailsBgAlpha": 100, // Thumbnails Background Alpha (value from 0 to 100). Default value: 100. Set the transparancy for the thumbnails background.
        "ThumbnailsSpacing": 5, // Thumbnails Background Alpha (value from 0 to 100). Default value: 100. Set the transparancy for the thumbnails background.
        ...
        "ImageMarginTop": 5, // Image Margin Top (value in pixels). Default value: 20. Set top margin value for the image.
        "ImageMarginRight": 5, // Image Margin Right (value in pixels). Default value: 20. Set right margin value for the image.
        "ImageMarginBottom": 5, // Image Margin Bottom (value in pixels). Default value: 20. Set bottom margin value for the image.
        ...
        "NavigationEnabled": "false", // Enable Navigation (true, false). Default value: true. Enable navigation buttons.
